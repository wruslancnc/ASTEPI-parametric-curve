...
char CurveType[10] = "A20-ASTEPI";
char CurveTypeDesc[80] = "ASTROID-EPICYCLOID ALGO=20 SKIP STEP2 RUN-STEP1 RUN-ADJFR FRATECMD=40";
...
// END BYPASS
  ...
  // START BYPASS STEP 1
      ...
      if (curr_eps > uppertol_bound)
       ...
       }  // ADD CLOSING BRACES FOR STEP 1 / REMOVE FOR RUNNING STEP 2
